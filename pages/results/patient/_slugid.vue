<template>
  <v-container fluid grid-list-md>
    ...
    <div id="patientCard">
      <v-card flat dark>
        <v-layout row wrap :class="`pa-3`">
          ...
          <v-flex xs12 sm4 md12 class="icon-container">
            <v-tooltip v-for="card in cards" :key="card.id" bottom>
              <template v-slot:activator="{ on }">
                <v-btn
                  ...
                  v-on="on"
                >
                  <v-icon dark style="font-size: 1.2rem">{{
                    card.icon
                  }}</v-icon>
                </v-btn>
              </template>
    ...
    <!-- DIAGNOSES VIEW -->
    <div class="card-container" id="diagnoses">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
          >Diagnosen</v-card-title
        >
        <v-data-table
        ...
        <v-tooltip bottom>
          ...
          <span>Zum Patientenkarten scrollen</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveUp('diagnoses')"
              flat
              color="grey"
              v-on="on"
            >
              <v-icon style="font-size: 1.2rem">fas fa-caret-up</v-icon>
            </v-btn>
          </template>
          <span>Diagnosen nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveDown('diagnoses')"
              flat
              color="grey"
              v-on="on"
            >
              <v-icon style="font-size: 1.2rem">fas fa-caret-down</v-icon>
            </v-btn>
          </template>
          <span>Diagnosen nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>

    <!-- FAMILY MEMBER DIAGNOSES VIEW -->
    <div class="card-container" id="familyMemberDiagnoses">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveUp('familyMemberDiagnoses')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Tumor-Erkrankungen bei Verwandten nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveDown('familyMemberDiagnoses')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Tumor-Erkrankungen bei Verwandten nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>

    <!-- GUIDELINE THERAPY VIEW -->
    <div class="card-container" id="guidelineTherapies">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveUp('guidelineTherapies')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Leitlinien-Therapien nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveDown('guidelineTherapies')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Leitlinien-Therapien nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>

    <!-- ECOG STATUS VIEW -->
    <div class="card-container" id="ecogStatus">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-tooltip bottom>
          ...
          <span>ECOG Status nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          ...
          <span>ECOG Status nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>
    <!-- SPECIMENS VIEW -->
    <div class="card-container" id="specimens">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        ...
        <v-tooltip bottom>
          ...
          <span>Proben nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          ...
          <span>Proben nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>

    <!-- MOLECULAR PATHOLOGY FINDINGS VIEW -->
    <div class="card-container" id="molecularPathologyFindings">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveUp('molecularPathologyFindings')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Molekular-Pathologie Befunde nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveDown('molecularPathologyFindings')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Molekular-Pathologie Befunde nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>

    <!-- HISTOLOGY REPORTS VIEW -->
    <div class="card-container" id="histologyReports">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-tooltip bottom>
          ...
          <span>Histologie Berichte nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveDown('histologyReports')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Histologie Berichte nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>

    <!-- NGS REPORTS VIEW -->
    <div class="card-container" id="ngsReports">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-card flat v-for="ngsReport in ngsReports" :key="ngsReport.id">
          <v-layout row wrap :class="`pa-3`">
            ...
            <v-flex xs6 sm2 md2>
              <div class="caption grey--text">
                Micro-Satellite Instabilitäten
              </div>
          ...
          <v-card-title class="font-weight-normal"
            ><v-flex d-flex>
              <v-switch
                v-if="displayMetadaten"
                v-model="displayMetadaten"
                :label="`Metadaten ausblenden`"
              ></v-switch>
              <v-switch
                v-else
                v-model="displayMetadaten"
                :label="`Metadaten einblenden`"
              ></v-switch> </v-flex
          ></v-card-title>

          <div v-if="displayMetadaten">
            <v-card
              flat
              color="#f0f0f0"
          ...
          <v-card-title class="font-weight-normal">
            <v-switch
              v-if="displaySimpleVariants"
              v-model="displaySimpleVariants"
              :label="`Einfache Varianten ausblenden`"
            ></v-switch>
            <v-switch
              v-else
              v-model="displaySimpleVariants"
              :label="`Einfache Varianten einblenden`"
            ></v-switch>
          </v-card-title>
          <div v-if="displaySimpleVariants">
            <v-card
              flat
              color="#e8e8e8"
          ...
          <v-card-title class="font-weight-normal"
            ><v-switch
              v-if="displayCopyNumberVariants"
              v-model="displayCopyNumberVariants"
              :label="`Copy Number Varianten ausblenden`"
            ></v-switch>
            <v-switch
              v-else
              v-model="displayCopyNumberVariants"
              :label="`Copy Number Varianten einblenden`"
            ></v-switch
          ></v-card-title>
          <div v-if="displayCopyNumberVariants">
            <v-card
              flat
              color="#f0f0f0"
          ...
          <v-card-title class="font-weight-normal"
            ><v-switch
              v-if="displayDNAFusions"
              v-model="displayDNAFusions"
              :label="`DNA-Fusions ausblenden`"
            ></v-switch>
            <v-switch
              v-else
              v-model="displayDNAFusions"
              :label="`DNA-Fusions einblenden`"
            ></v-switch
          ></v-card-title>
          <div v-if="displayDNAFusions">
            <v-card
              flat
              color="#e8e8e8"
          ...
          <v-card-title class="font-weight-normal"
            ><v-switch
              v-if="displayRNAFusions"
              v-model="displayRNAFusions"
              :label="`RNA-Fusions ausblenden`"
            ></v-switch>
            <v-switch
              v-else
              v-model="displayRNAFusions"
              :label="`RNA-Fusions einblenden`"
            ></v-switch
          ></v-card-title>
          <div v-if="displayRNAFusions">
            <v-card
              flat
              color="#f0f0f0"
        ...
        <v-tooltip bottom>
          ...
          <span>Somatische NGS-Berichte nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          ...
          <span>Somatische NGS-Berichte nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>
    ...
    <!-- CARE PLANS VIEW -->
    <div class="card-container" id="carePlans">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-card flat v-for="carePlan in carePlans" :key="carePlan.id">
          ...
          >
            ...
            <v-layout row wrap :class="`pa-3`">
              ...
              <v-flex xs6 sm4 md3>
                <div class="caption grey--text">Wirkstoff-Klassen</div>
              ...
              <v-flex xs6 sm4 md12>
                ...
                <div>
                  {{ therapyRecommendation.supportingVariants.join(", ") }}
                </div>
              </v-flex>
            </v-layout>
          </v-card>
        ...
        <v-tooltip bottom>
          ...
          <span>MTB-Beschluss nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          ...
          <span>MTB-Beschluss nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>
    <!--
    ...
    <!-- CLAIM STATUS VIEW -->
    <div class="card-container" id="claimResponses">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-tooltip bottom>
          ...
          <span>Kostenübernahme-Anträge nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          ...
          <span>Kostenübernahme-Anträge nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>
    ...
    <div class="card-container" id="molecularTherapies">
      <v-card hover flat>
        <v-divider class="my-3"></v-divider>
        <v-card-title class="headline font-weight-light"
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveUp('molecularTherapies')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Molekulare Therapien nach oben verschieben</span>
        </v-tooltip>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on }">
            <v-btn
              small
              icon
              @click="moveDown('molecularTherapies')"
              flat
              color="grey"
              v-on="on"
            >
          ...
          <span>Molekulare Therapien nach unten verschieben</span>
        </v-tooltip>
      </v-card>
    </div>
    <br />
    ...
    <v-tooltip bottom>
      <template v-slot:activator="{ on }">
        <v-btn small icon @click="resetOrder" flat color="purple" v-on="on">
          <v-icon style="font-size: 1.2rem">fas fa-undo</v-icon>
        </v-btn>
      </template>
      <span>Reihenfolge zurücksetzen</span>
    </v-tooltip>
...
export default {
  ...
  data() {
    return {
      ...
      order: [],
      cards: [
        { id: "diagnoses", name: "Diagnosen", icon: "fas fa-diagnoses" },
        {
          id: "familyMemberDiagnoses",
          name: "Tumor-Erkrankungen bei Verwandten",
          icon: "fas fa-users",
        },
        {
          id: "guidelineTherapies",
          name: "Leitlinien-Therapien",
          icon: "fas fa-book",
        },
        { id: "ecogStatus", name: "ECOG Status", icon: "fas fa-chart-line" },
        { id: "specimens", name: "Proben", icon: "fas fa-flask" },
        {
          id: "molecularPathologyFindings",
          name: "Molekular-Pathologie Befunde",
          icon: "fas fa-dna",
        },
        {
          id: "histologyReports",
          name: "Histologie Berichte",
          icon: "fas fa-file-alt",
        },
        {
          id: "ngsReports",
          name: "Somatische NGS-Berichte",
          icon: "fas fa-chart-bar",
        },
        { id: "carePlans", name: "MTB-Beschluss", icon: "fas fa-stethoscope" },
        {
          id: "claimResponses",
          name: "Kostenübernahme-Anträge",
          icon: "fas fa-file-invoice",
        },
        {
          id: "molecularTherapies",
          name: "Molekulare Therapien  ",
          icon: "fas fa-atom",
        },
      ],
      orderChangeMessage: "",
  ...
  methods: {
    moveUp(id) {
      ...
      if (
        previousElement &&
        previousElement.classList.contains("card-container")
      ) {
    ...
    moveDown(id) {
      ...
      if (nextElement && nextElement.classList.contains("card-container")) {
    ...
    /* here we save the card order with local storage
    saveOrder() {
      const cardContainers = document.querySelectorAll(".card-container");
      const order = Array.from(cardContainers).map((container) => container.id);
    ...
    resetOrder() {
      ...
      localStorage.setItem("cardOrder", JSON.stringify(defaultOrder));
    ...
    */
    ...
    saveOrder() {
      try {
        const cardContainers = document.querySelectorAll(".card-container");
        const order = Array.from(cardContainers).map(
          (container) => container.id
        );

        const orderString = JSON.stringify(order);
        document.cookie = `cardOrder=${encodeURIComponent(
          orderString
        )}; expires=...`;
        this.loadOrder();
      } catch (error) {
        console.error("Error stringifying array to JSON:", error);
      }
    },
    ...
    loadOrder() {
      this.$nextTick(() => {
        try {
          ...
          const orderCookie = cookies.find((cookie) =>
            cookie.startsWith("cardOrder=")
          );

          if (orderCookie) {
            const orderString = decodeURIComponent(orderCookie.split("=")[1]);
    ...
    resetOrder() {
      try {
        ...
        const defaultOrderString = JSON.stringify(defaultOrder);
  ...
  async asyncData({ params, redirect, error }) {
    ...
    try {
      ...
      return {
        ...
        displayMetadaten: false,
        displaySimpleVariants: false,
        displayCopyNumberVariants: false,
        displayDNAFusions: false,
        displayRNAFusions: false,
        displayRNASeqs: false,
      };
    } catch (err) {
