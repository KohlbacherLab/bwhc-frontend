  ...
  <v-responsive>
    <v-container fluid grid-list-md>
      ...
      <span class="subheading font-weight-light">
        ...
        >Query results are displayed below some informative text can be
        displayed here.
      ...
      <v-flex d-flex>
        <v-expansion-panel>
          <v-expansion-panel-content>
                ...
                <v-hover>
                  <v-card flat>
                    <v-card-text class="subheading font-weight-thin">
                      <span v-if="getQueryParametersMutations">
                      ...
                      <span v-if="getQueryParametersResponses">
                        <strong>Responses</strong>
                        {{ getQueryParametersResponses.join(", ") }}
                        <br />
                      </span>
                      <span v-if="getQueryParametersFederated">
            ...
            <center>
              <v-card-text class="subheading font-weight-thin">
                ⚠️ reloading the parameters of 'Mutations' and 'Drugs' are
                currently inactive! 🚧
              </v-card-text>
            </center>
          </v-expansion-panel-content>
            ...
            <v-data-table :headers="headerFiles" :items="itemsFiles">
              <template slot="items" slot-scope="props" no-data>
                <tr @click="routeToPatient(queryId + '&' + props.item.id)">
                  ...
                  <!--
                  <td>{{ props.item.age.value }}</td>
                  <td>
                    {{
                      props.item.diagnoses
                        .map(function (x) {
    ...
    */
    ...
    for (
      ...
      getQueryParametersDrugs.push(
        queryparams.data.parameters.medicationsWithUsage[i].drug +
          " " +
