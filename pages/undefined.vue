  ...
  <v-container fluid grid-list-md>
    ...
    <v-flex d-flex xs12 sm6 md3>
      ...
      >
        <v-card-text class="headline font-weight-thin">
          ...
          <br />Die Sitzung ist abgelaufen oder der Session Token wurde nicht gefunden.
        </v-card-text>
      </v-card>
    </v-flex>
    <br />
    <v-flex d-flex xs12 sm6 md12>
      <span class="headline font-weight-thin"
        ><strong>Das ist ein Fehler!</strong><br />Es tut uns leid, aber Sie haben keinen Zugriff auf diese Seite oder Ressource.<br> <strong @click="$router.push('/')">Versuchen Sie, sich erneut anzumelden.</strong>
      </span>
    </v-flex>
  </v-container>
</template>