<template>
  <v-container fluid grid-list-md>
    ...
    <div id="issues"></div>
    <v-divider class="my-3"></v-divider>
    <v-card-title class="headline font-weight-light">Probleme</v-card-title>
    <v-data-table
...
export default {
  ...
  data: () => ({
    ...
    headerIssues: [
      ...
      {
        text: "Lokalisierung - Objekt-Typ",
        align: "left",
        sortable: true,
        value: "location",
      },
      {
        text: "Lokalisierung - Objekt-ID",
        align: "left",
        sortable: true,
        value: "location",
      },
      {
        text: "Lokalisierung - Attribut",
        align: "left",
        sortable: true,
        value: "location",
      },
